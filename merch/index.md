...
<div class="grid" style="grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem;">
  ...
  <div class="card" style="padding: 0; overflow: hidden;">
    <a href="https://www.amazon.com/dp/B0HGBQSQLW" target="_blank" rel="noopener" style="display: block; text-decoration: none !important;">
      <img
        src="{{ '/assets/images/diablo_adaptive-mesh_hsl_relief_height_ex1p5_250lines_lw1p5_4000x2288_transparent(1).png' | relative_url }}"
        alt="Mount Diablo Topographic Wireframe T-Shirt"
        style="width: 100%; height: 260px; object-fit: cover; background: #000; display: block;"
        onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';"
      >
      <div style="display: none; height: 260px; background: #0d1117; align-items: center; justify-content: center; font-size: 4rem;">🏔️</div>
    </a>
    <div style="padding: 1.25rem;">
  ...
  <div class="card" style="padding: 0; overflow: hidden;">
    <a href="https://www.amazon.com/dp/B0HDFS7DP8" target="_blank" rel="noopener" style="display: block; text-decoration: none !important;">
      <img
        src="{{ '/assets/images/form_constant.png' | relative_url }}"
  ...
  <!-- Launching Soon -->
  <div class="card" style="padding: 0; overflow: hidden;">
    <a href="https://www.amazon.com/dp/B0HCJM78ZJ" target="_blank" rel="noopener" style="display: block; text-decoration: none !important;">
      <img
        src="{{ '/assets/images/launching_soon.png' | relative_url }}"
        alt="Launching Soon T-Shirt"
    ...
    <div style="padding: 1.25rem;">
      ...
      <h3 style="margin: 0 0 0.75rem 0; font-size: 1.15rem; line-height: 1.35;">Launching Soon Graphic T-Shirt</h3>
      <p style="font-size: 0.9rem; color: var(--text-muted); margin-bottom: 1rem;">
      ...
      <a href="https://www.amazon.com/dp/B0HCJM78ZJ" target="_blank" rel="noopener" class="btn btn-primary" style="width: 100%; text-align: center; display: block; box-sizing: border-box;">
        View on Amazon →
      </a>
    </div>
  </div>
  ...
  <div class="card" style="padding: 0; overflow: hidden;">
    <a href="https://www.amazon.com/s?k=litestep" target="_blank" rel="noopener" style="display: block; text-decoration: none !important;">
      <img
        ...
        alt="Bay Area Topographic Ridgeline Shirt"
        style="width: 100%; height: 260px; object-fit: contain; background: #000; display: block;"
      >
    </a>
    <div style="padding: 1.25rem;">
  ...
  <!-- Stay Golden -->
  <div class="card" style="padding: 0; overflow: hidden;">
    <div style="display: flex; align-items: center; justify-content: center; height: 260px; background: #0d1117;">
      <img
        src="{{ '/assets/images/stay_golden.png' | relative_url }}"
        alt="Stay Golden Graphic Tee"
        style="max-width: 100%; max-height: 260px; object-fit: contain; display: block;"
      >
    </div>
    <div style="padding: 1.25rem;">
      <div style="font-size: 0.75rem; text-transform: uppercase; font-weight: 700; color: var(--text-muted); margin-bottom: 0.35rem;">Bay Area Graphic · Classic Design</div>
      <h3 style="margin: 0 0 0.75rem 0; font-size: 1.15rem; line-height: 1.35;">Stay Golden Series</h3>
      <p style="font-size: 0.9rem; color: var(--text-muted); margin-bottom: 1rem;">
